...
export const SOURCE_OPERATION_POLICIES: readonly SourceOperationPolicy[] = [
  ...
  { sourceId: "xai_san-francisco_social_pulse", minimumRefreshMinutes: 12, requestLimitPerRun: 2, requestLimitPerDay: 120, credentialEnv: "XAI_API_KEY", preserveLastGood: true, rawRetention: "none", rawRetentionHours: 0, attributionRequired: true, textReuse: "facts_only", imageReuse: "prohibited_without_explicit_license" },
  { sourceId: "xai_stockholm_social_pulse", minimumRefreshMinutes: 12, requestLimitPerRun: 2, requestLimitPerDay: 120, credentialEnv: "XAI_API_KEY", preserveLastGood: true, rawRetention: "none", rawRetentionHours: 0, attributionRequired: true, textReuse: "facts_only", imageReuse: "prohibited_without_explicit_license" },
