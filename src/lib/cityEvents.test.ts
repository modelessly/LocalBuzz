...
describe("city event snapshot client", () => {
  it("describes retained age and unavailable sources honestly", () => {
    const description = describeCityEventSnapshot({ cityId: "stockholm", generatedAt: "2026-09-01T10:00:00Z", retained: true, happenings: [], sources: [{ sourceId: "tm", publisher: "Ticketmaster", status: "unavailable", attemptedAt: "2026-09-01T12:00:00Z", eventCount: 0, rejectedCount: 0 }] });
