...
export const createWebMcpTools = (actions: LocalBuzzActions): WebMcpTool[] => [
  ...
  },
  {
    ...
    inputSchema: { type: "object", properties: { ...proposalBaseSchema, fields: { type: "object", properties: {
      name: { type: "string", maxLength: 300 }, officialWebsite: { type: "string", format: "uri" }, reservationUrl: { type: "string", format: "uri" }, kind: { type: "string", enum: ["restaurant", "bar", "pub", "cocktail_lounge", "wine_bar", "music_bar", "club", "cafe"] },
    ...
    execute(input) {
      ...
      const facts: PlaceDiscoveryFields = {
        name: typeof fields.name === "string" ? fields.name : undefined, officialWebsite: typeof fields.officialWebsite === "string" ? fields.officialWebsite : undefined, reservationUrl: typeof fields.reservationUrl === "string" ? fields.reservationUrl : undefined, kind: typeof fields.kind === "string" ? fields.kind as PlaceKind : undefined,
